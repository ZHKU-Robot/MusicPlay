...
"border:2px solid rgb(214, 204, 216);\n"
"border-radius:2px;\n"
"")
        ...
        self.musiclistTable.setGridStyle(QtCore.Qt.CustomDashLine)
...
"")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/buttonicon/MusicButtonIcon/listcircle.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/buttonicon/MusicButtonIcon/volume-off.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnvolum.setIcon(icon5)
...
"margin: 0px;")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/buttonicon/MusicButtonIcon/history.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnHistory.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/buttonicon/MusicButtonIcon/Music.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPlayList.setIcon(icon7)
        self.actionPlayList.setObjectName("actionPlayList")
        self.actionBtnMV = QtWidgets.QAction(MusicPlayerMainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/buttonicon/MusicButtonIcon/media.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBtnMV.setIcon(icon8)
    ...
    def retranslateUi(self, MusicPlayerMainWindow):
        ...
        self.label_2.setText(_translate("MusicPlayerMainWindow", "00:00"))
        self.label_3.setText(_translate("MusicPlayerMainWindow", "00:00"))

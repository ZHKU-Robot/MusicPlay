...
"    background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1,stop: 0 #dadbde, stop: 1 #f6f7fa);};")
        ...
        self.lyricsWindow = QtWidgets.QListWidget(MusicWindow)
        self.lyricsWindow.setEnabled(True)
        self.lyricsWindow.setResizeMode(QtWidgets.QListView.Adjust)
        self.lyricsWindow.setSelectionRectVisible(True)
        self.lyricsWindow.setObjectName("lyricsWindow")
        self.horizontalLayout_2.addWidget(self.lyricsWindow)
